...
const TravelItinerary = ({ params }: PageProps) => {
  ...
  const parseRawResponse = (rawResponse: string): Section[] => {
    ...
    return rawSections.map((section) => {
      ...
      if (title.toLowerCase().includes("time to visit")) {
        ...
        icon = <TransportIcon />;
      } else if (title.toLowerCase().includes("Travel Guide")) {
        icon = <LocationIcon />;
      } else if (title.toLowerCase().includes("things to do")) {
        icon = <ActivityIcon />;
      } else if (title.toLowerCase().includes("Itinerary")) {
        icon = <HotelIcon />;
      } else if (title.toLowerCase().includes("where to eat")) {
        icon = <FoodIcon />;
      } else if (title.toLowerCase().includes("Highlights")) {
        icon = <TipsIcon />;
      } else {
        icon = <InfoIcon />;
      }
  ...
  // const sections = parseItineraryData(itinerary.rawResponse);
